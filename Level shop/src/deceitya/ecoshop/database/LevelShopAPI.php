...
class LevelShopAPI {
    ...
    protected function init(): void {
        ...
        $this->register(VanillaBlocks::DARK_OAK_LOG()->asItem(), 25, 15);##Dark Oak Log
        #Stones
        ...
        $this->register(VanillaBlocks::LAPIS_LAZULI_ORE()->asItem(), 50000, 40);##Lapis Lazuli Ore
        ...
        $this->register(VanillaBlocks::NETHER_QUARTZ_ORE()->asItem(), 50000, 30);##Nether Quartz Ore
        ...
        #Dyes
        $this->register(VanillaItems::WHITE_DYE(), 5, 0);##White Dye
        $this->register(VanillaItems::LIGHT_GRAY_DYE(), 5, 0);##Light Gray Dye
        $this->register(VanillaItems::GRAY_DYE(), 5, 0);##Gray Dye
        $this->register(VanillaItems::BLACK_DYE(), 5, 0);##Black Dye
        $this->register(VanillaItems::BROWN_DYE(), 5, 0);##Brown Dye
        $this->register(VanillaItems::RED_DYE(), 5, 0);##Red Dye
        $this->register(VanillaItems::ORANGE_DYE(), 5, 0);##Orange Dye
        $this->register(VanillaItems::YELLOW_DYE(), 5, 0);##Yellow Dye
        $this->register(VanillaItems::LIME_DYE(), 5, 0);##Lime Dye
        $this->register(VanillaItems::GREEN_DYE(), 5, 0);##Green Dye
        $this->register(VanillaItems::CYAN_DYE(), 5, 0);##Cyan Dye
        $this->register(VanillaItems::LIGHT_BLUE_DYE(), 5, 0);##Light Blue Dye
        $this->register(VanillaItems::BLUE_DYE(), 5, 0);##Blue Dye
        ...
        $this->register(VanillaBlocks::SMOOTH_QUARTZ()->asItem(), 10, 3);##Smooth Quartz Block
        $this->register(VanillaBlocks::SMOOTH_SANDSTONE()->asItem(), 10, 0);##Smooth Sandstone
        $this->register(VanillaBlocks::SMOOTH_RED_SANDSTONE()->asItem(), 10, 0);##Smooth Red Sandstone
        #Elytra
        ...
        #Vegetation
        $this->register(VanillaBlocks::DANDELION()->asItem(), 30, 0);##Dandelion
        $this->register(VanillaBlocks::POPPY()->asItem(), 30, 0);##Poppy
        $this->register(VanillaBlocks::BLUE_ORCHID()->asItem(), 30, 0);##Blue Orchid
        $this->register(VanillaBlocks::ALLIUM()->asItem(), 30, 0);##Allium
        $this->register(VanillaBlocks::AZURE_BLUET()->asItem(), 30, 0);##Azure Bluet
        $this->register(VanillaBlocks::RED_TULIP()->asItem(), 30, 0);##Red Tulip
        $this->register(VanillaBlocks::ORANGE_TULIP()->asItem(), 30, 0);##Orange Tulip
        $this->register(VanillaBlocks::WHITE_TULIP()->asItem(), 30, 0);##White Tulip
        $this->register(VanillaBlocks::PINK_TULIP()->asItem(), 30, 0);##Pink Tulip
        $this->register(VanillaBlocks::OXEYE_DAISY()->asItem(), 30, 0);##Oxeye Daisy
        $this->register(VanillaBlocks::CORNFLOWER()->asItem(), 30, 0);##Cornflower
        $this->register(VanillaBlocks::LILY_OF_THE_VALLEY()->asItem(), 30, 0);##Lily of the Valley
        $this->register(VanillaBlocks::LILAC()->asItem(), 30, 0);##Lilac
        $this->register(VanillaBlocks::ROSE_BUSH()->asItem(), 30, 0);##Rose Bush
        $this->register(VanillaBlocks::PEONY()->asItem(), 30, 0);##Peony
        $this->register(VanillaBlocks::FERN()->asItem(), 30, 0);##Fern
        $this->register(VanillaBlocks::LARGE_FERN()->asItem(), 30, 0);##Large Fern
        $this->register(VanillaBlocks::TALL_GRASS()->asItem(), 30, 0);##Tall Grass
        $this->register(VanillaBlocks::DOUBLE_TALLGRASS()->asItem(), 30, 0);##Double Tallgrass
        $this->register(VanillaBlocks::DEAD_BUSH()->asItem(), 30, 0);##Dead Bush
        $this->register(VanillaBlocks::DEAD_BUSH()->asItem(), 30, 0);##Dead Bush
        $this->register(VanillaBlocks::DEAD_BUSH()->asItem(), 30, 0);##Dead Bush
        $this->register(VanillaBlocks::LILY_PAD()->asItem(), 30, 0);##Lily Pad
        $this->register(VanillaBlocks::VINES()->asItem(), 30, 0);##Vines
        #DecorativeBlock
        ...
        $this->register(VanillaBlocks::ELEMENT_CONSTRUCTOR()->asItem(), 25000, 0);##Element Constructor
