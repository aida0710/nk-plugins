...
use ErikPDev\AdvanceDeaths\{API};
use ErikPDev\AdvanceDeaths\Commands\advancedeaths;
use ErikPDev\AdvanceDeaths\effects\{Creeper, Lighting};
use ErikPDev\AdvanceDeaths\Listeners\{EconomySupport, instantRespawn, ScoreHUDListener};
use ErikPDev\AdvanceDeaths\utils\{configUpdater, configValidator, DatabaseProvider};
...
class Main extends PluginBase implements Listener {
    ...
    public function onEnable(): void {
        ...
        if ($this->FloatingTxtSupported !== true) {
            return;
        }
