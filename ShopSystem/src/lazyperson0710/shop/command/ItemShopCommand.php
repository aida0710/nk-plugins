...
use lazyperson0710\shop\form\item_shop\other\InvSellConfirmationForm;
use lazyperson0710\shop\form\item_shop\other\OtherShopSelectForm;
use lazyperson0710\shop\form\item_shop\other\SearchItemForm;
...
class ItemShopCommand extends Command {
    ...
    public function execute(CommandSender $sender, string $commandLabel, array $args) : void {
        ...
        match ($args[0]) {
            ...
            '4' => LevelCheck::sendForm($sender, new CategorySelectForm($sender, 4), RestrictionShop::RESTRICTION_LEVEL_SHOP_4),
            '5' => LevelCheck::sendForm($sender, new CategorySelectForm($sender, 5), RestrictionShop::RESTRICTION_LEVEL_SHOP_5),
            '6' => LevelCheck::sendForm($sender, new CategorySelectForm($sender, 6), RestrictionShop::RESTRICTION_LEVEL_SHOP_6),
            '7' => LevelCheck::sendForm($sender, new CategorySelectForm($sender, 7), RestrictionShop::RESTRICTION_LEVEL_SHOP_7),
