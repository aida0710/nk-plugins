...
class GachaItemAPI {
    ...
    public function init(): void {
        ...
        ## SSR Rank
        $this->dischargeItemRegister("常駐ガチャ", "SSR", VanillaItems::DRAGON_BREATH(), 1, "繝｢繝ｳ繧ｹ繧ｿ繝ｼ", "驛｢譎｢?ｽ?｢驛｢譎｢?ｽ?ｳ驛｢?ｧ??ｹ驛｢?ｧ??ｿ驛｢譎｢?ｽ?ｼ", [VanillaEnchantments::PUNCH()], [1], ["UnknownItem"]);
        $this->dischargeItemRegister("常駐ガチャ", "SSR", VanillaItems::SWEET_BERRIES(), 1, "コーラル バタフライ", "効果\n\n採掘速度上昇 lv.50 15分\n二分の一の確率でデメリットが発生します", [VanillaEnchantments::PUNCH()], [1], ["CoralButterfly"]);
        $this->dischargeItemRegister("常駐ガチャ", "SSR", VanillaItems::POISONOUS_POTATO(), 1, "クリーミーポテト", "本当にクリームみたいな柔らかさのじゃかいもだね\n\n効果\n\n採掘速度上昇 lv.3 60秒\n5秒経過後に毒 lv.5 25秒", [VanillaEnchantments::PUNCH()], [1], ["CreamyPotato"]);
